    ...
    return(
        <div className={`bg-white dark:bg-[#2a2a2a] h-[100vh] pt-5 pb-5 pl-3 pr-4 cursor-pointer fixed top-0 left-0`} style={{ width: sidebarWidth, transition: "width 0.5s ease" }}>
            ...
            <nav>
                <ul>
                    <li className="flex mb-[10px] mt-[10px]">
                        <a href="/home" className="relative group w-full h-[45px] flex items-center rounded-lg hover:bg-[#E8DEF8] dark:hover:bg-[#484848] transition-colors duration-300 cursor-pointer">
                        ...
                        <span className={`dark:text-white ml-2 flex transition-all duration-500 whitespace-nowrap ${sidebarWidth === "80px" ? 'hidden' : 'inline'}`}>Home</span>
                        <span className="absolute left-full top-1/2 transform -translate-y-1/2 ml-2 p-3 bg-white dark:bg-[#2a2a2a] dark:text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            Home
                        </span>
                        </a>
                    ...
                    <li className="flex mb-[10px] mt-[10px]">
                        ...
                        <span className={`dark:text-white ml-2 flex transition-all duration-500 whitespace-nowrap ${sidebarWidth === "80px" ? 'hidden' : 'inline'}`}>Profile</span>
                        <span className="absolute left-full top-1/2 transform -translate-y-1/2 ml-2 p-3 bg-white dark:bg-[#2a2a2a] dark:text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            Profile
                        </span>
                        </a>
                    ...
                    <li className="flex mb-[10px] mt-[10px]">
                        <a href="/mapWithRoute" className="relative group w-full h-[45px] flex items-center rounded-lg hover:bg-[#E8DEF8] dark:hover:bg-[#484848] transition-colors duration-300 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 min-w-[50px] dark:stroke-white">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498 4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 0 0-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0Z" />
                        </svg>
                        <span className={`dark:text-white ml-2 flex transition-all duration-500 whitespace-nowrap ${sidebarWidth === "80px" ? 'hidden' : 'inline'}`}>Places</span>
                        <span className="absolute left-full top-1/2 transform -translate-y-1/2 ml-2 p-3 bg-white dark:bg-[#2a2a2a] dark:text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            Map
                        </span>
                        </a>
                    ...
                    <li className="flex mb-[10px] mt-[10px]">
                        <a href="/favorites" className="relative group w-full h-[45px] flex items-center rounded-lg hover:bg-[#E8DEF8] dark:hover:bg-[#484848] transition-colors duration-300 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 min-w-[50px] dark:stroke-white">
            ...
            <div className="flex mb-[10px] mt-[10px]">
                <div className="relative group w-full h-[45px] flex items-center rounded-lg hover:bg-[#E8DEF8] dark:hover:bg-[#484848] transition-colors duration-300 cursor-pointer group" onClick={darkMode}>
