            ...
            <nav className="navegation">
                <ul>
                    <li className="flex mb-[10px] mt-[10px]">
                        ...
                        <span className={`ml-2 flex transition-all duration-500 whitespace-nowrap ${sidebarWidth === "80px" ? 'hidden' : 'inline'}`}>Home</span>
                        </a>
                    </li>
                    <li className="flex mb-[10px] mt-[10px]">
                        <a href="#" className="w-full h-[45px] flex items-center rounded-lg hover:bg-[#E8DEF8] transition-colors duration-300 cursor-pointer">
                        ...
                        <span className={`ml-2 flex transition-all duration-500 whitespace-nowrap ${sidebarWidth === "80px" ? 'hidden' : 'inline'}`}>Profile</span>
                        </a>
                    </li>
                    <li className="flex mb-[10px] mt-[10px]">
                        <a href="#" className="w-full h-[45px] flex items-center rounded-lg hover:bg-[#E8DEF8] transition-colors duration-300 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 min-w-[50px]">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498 4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 0 0-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0Z" />
                        </svg>
                        <span className={`ml-2 flex transition-all duration-500 whitespace-nowrap ${sidebarWidth === "80px" ? 'hidden' : 'inline'}`}>Places</span>
                        </a>
                    </li>
                    <li className="flex mb-[10px] mt-[10px]">
                        <a href="#" className="w-full h-[45px] flex items-center rounded-lg hover:bg-[#E8DEF8] transition-colors duration-300 cursor-pointer">
                        ...
                        <span className={`ml-2 flex transition-all duration-500 whitespace-nowrap ${sidebarWidth === "80px" ? 'hidden' : 'inline'}`}>Favorites</span>
                        </a>
                    </li>
                </ul>
            </nav>
