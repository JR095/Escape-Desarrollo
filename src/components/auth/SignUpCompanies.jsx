    ...
    return (
        ...
        <div className="flex justify-center items-center">
            ...
            <form className="ww-full lg:w-2/4" onSubmit={handleSubmit}>
                ...
                <AuthInput name="name" placeholder={t('iCompanyName')} type="text" onChange={e => setName(e.target.value)}/>
                <AuthInput name="phone_number" placeholder={t('iPhone')} type="text" onChange={e => setPhone_number(e.target.value)}/>
                <AuthInput name="email" placeholder={t('iEmail')} type="email" onChange={e => setEmail(e.target.value)}/>
                <AuthInput name="description" placeholder={t('Description')} type="text" onChange={e => setDescription(e.target.value)}/>
                <AuthInput name="address" placeholder={t('Address')} type="text" onChange={e => setAddress(e.target.value)}/>
