  ...
  return (
    ...
    <div className='absolute right-0 bg-white p-4 rounded shadow-lg z-10 dark:bg-[#2a2a2a] md:w-[25vw] w-full h-[100vh]'>
      ...
      {placeInformation.image && (
        <div className="p-4 rounded-lg bg-gray-100 dark:bg-[#404040] shadow-lg w-[90%] md:w-[100%]">
          ...
          <h2 className="text-black font-semibold text-xl md:text-2xl dark:text-[#BCBCBC]">{t('Estimated Time')}:</h2>
          <p className='text-black font-semibold text-xl md:text-2xl dark:text-[#BCBCBC]'>{EstimatedHour || 'N/A'}</p>
          
          <h2 className="text-black font-semibold text-xl md:text-2xl dark:text-[#BCBCBC]">{t('Travel Time')}:</h2>
          <p className='text-black font-semibold text-xl md:text-2xl dark:text-[#BCBCBC]'>{travelTime || 'N/A'}</p>
        </div>
