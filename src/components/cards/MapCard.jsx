      ...
      >
              ...
              {filteredPlaces.map((place) => (
                <li
                  ...
                  onClick={() => {
                    ...
                    setPlaceInformation({
                      name: place.name,
                      subCategory: place.sub_category_id || '',
        ...
        {placeInformation.image && (
          <div className="p-4 rounded-lg bg-gray-100 dark:bg-[#404040] shadow-lg md:w-[100%] my-4">
            ...
            <div className="flex lg:flex-row max-[1118px]:grid items-center justify-between my-2">

              <p className="dark:text-white mt-2 font-bold text-2xl">{placeInformation.name}</p>   

              <div className="grid bg-white dark:bg-[#404040] dark:border-gray-600 border border-gray-200 rounded-2xl shadow p-2">
                <p className='text-black font-semibold lg:text-xl md:text-2xl dark:text-[#BCBCBC]'>{placeInformation.subCategory}</p>
              </div>               

            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 bg-white dark:bg-[#404040] dark:border-gray-600 border border-gray-200 rounded-lg shadow p-4 gap-4">
              ...
              <div className="flex items-center space-x-2">
                  ...
                  <p className='text-black font-semibold lg:text-xl md:text-2xl dark:text-[#BCBCBC]'>{travelTimeWalk || 'N/A'}</p>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <p className='text-black font-semibold lg:text-xl md:text-2xl dark:text-[#BCBCBC]'>{travelTimeBike || 'N/A'}</p>
              </div>
              ...
              <div className="flex items-center space-x-2">         
                ...
                <p className='text-black font-semibold lg:text-xl md:text-2xl dark:text-[#BCBCBC]'>{travelTimeCar || 'N/A'}</p>
              </div>

            </div>

            <button onClick={handleClickButton} className="w-full bg-sky-500 text-white font-bold py-2 rounded-lg mt-4 text-lg">{t('Go')}</button>
